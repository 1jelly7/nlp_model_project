...
class TextCNN(nn.Module):
    ...
    def train_one_epoch(self, data_loader: DataLoader, criterion: nn.Module,
    ...
    def evaluate(self, data_loader: DataLoader, criterion: nn.Module, device: torch.device) -> tuple[
        float, float]:
